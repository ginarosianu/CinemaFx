...
import UI.ScannerForMovieAndCardsInformationPlusDateConverter;
...
public class NewUI {
    ...
    public NewUI(MovieService movieService, ClientService cardService, BookingService bookingService) {
