...
public class CardController {
    ...
    public void btnAddClick(ActionEvent actionEvent) {
        try {
            ...
            clientService.insert(id, name, surname, CNP, birthday, registrationDate, bonusPoints);
    ...
    public void btnUpdateClick(ActionEvent actionEvent) {
        try {
            ...
            clientService.update(id, name, surname, CNP, birthday, registrationDate, bonusPoints);
            btnCancelClick(actionEvent);
        } catch (RuntimeException rex) {
            Common.showValidationError(rex.getMessage());
        }
